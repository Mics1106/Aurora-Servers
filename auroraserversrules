...
39. NO AFK FARMING OF ANYTHING THAT GAINS MONEY (automoney collectors on clickers are allowed while active, as soon as you're afk they're banned, includes all forms of money MINING, bitcoin, time, etc)
40. Cop cars are not allowed to be stolen via carjacks.
41. You are only allowed to use one machine in the games room at once!
42. Using Titles to display a rank that you are not (via custom) IS NOT ALLOWED, custom is there for you to have fun names not to do staff, if this is broke too much it will be removed!
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Default Laws:
...
You are not allowed to have guns.
...
You are not allowed to raid.
You are only allowed to base in sidewalks, alleys, tunnels with dead end, and tree houses.
...
Hitman
You are not allowed to raid (unless suspect is in base).
You are not allowed to mug.
You are not allowed to steal.
